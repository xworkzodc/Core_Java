...
public class CameraRunner {
	...
	public static void main(String[] args)
	{
		...
		cameradto3.setPrice(70000);
		
		
		
		CameraDAO dao=new CameraImplementedDAO();
		
		CameraImplementedDAO castedDAO=(CameraImplementedDAO)dao;
