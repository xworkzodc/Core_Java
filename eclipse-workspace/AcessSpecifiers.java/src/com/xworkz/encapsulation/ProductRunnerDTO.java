...
public class ProductRunnerDTO {
		 ...
		 ProductDTO product8=new ProductDTO();
			...
			System.out.println(product8.getWatchcouriercharge());
			 ...
			 ProductDTO product9=new ProductDTO();
				...
				/*private String aircooler="IFB";
    private int aircoolerprice;
	private int aircoolersize;
	private String aircoolercolor;
	...
	private int aircoolercouriercharge;*/
				...
				product10.setAircoolercolor("RED");
				System.out.println(product10.getAircoolercolor());
				...
				product10.setAircoolermanufacturePlace("NELLORE");
               ...
               ProductDTO product11=new ProductDTO();
				...
				product11.setAircoolersize(150);
				System.out.println(product11.getAircoolersize());
				
				product11.setAircoolercolor("RED-GREEN");
				System.out.println(product11.getAircoolercolor());
				...
				product11.setAircoolermanufacturePlace("VIZAG");
				...
				product11.setAircoolercouriercharge(1300);
				System.out.println(product11.getAircoolercouriercharge());
	               ...
	               ProductDTO product12=new ProductDTO();
					...
					product12.setAircoolercolor("GREEN");
					System.out.println(product12.getAircoolercolor());
					
					
					product12.setAircoolerweight(120.0);
					...
					product12.setAircoolermanufacturePlace("VIZAG");
					...
					System.out.println(product12.getAircoolercouriercharge());
					 ...
					 ProductDTO product13=new ProductDTO();
						...
						product13.setAircooler("BLUE DARK PONT");
						System.out.println(product13.getAircooler());
						
						product13.setAircoolerprice(10300);
						System.out.println(product13.getAircoolerprice());
						
						product13.setAircoolersize(350);
						System.out.println(product13.getAircoolersize());
						
						product13.setAircoolercolor("GREEN");
						System.out.println(product13.getAircoolercolor());
						
						
						product13.setAircoolerweight(130.0);
						...
						product13.setAircoolermanufacturePlace("GUNTUR");
					...
					System.out.println(" 4 Instance of product");
						 ...
						 product14.setWashingMachineaircoolercolor("WHITE-GREEN MICED");
						 System.out.println(product14.getWashingMachineaircoolercolor());
						 ...
						 product14.setAircoolermanufacturePlace("NAGOLE");
						 ...
						 product14.setAircoolercouriercharge(1000);
						 ...
						 product15.setWashingMachine("PANASONIC SMART NEW");
						 ...
						 product15.setWashingMachineaircoolercolor("WHITE-GREEN MICED");
						 System.out.println(product15.getWashingMachineaircoolercolor());
						 ...
						 product15.setAircoolermanufacturePlace("NAIDUPETA");
						 ...
						 product16.setWashingMachineaircoolercolor("WHITE-GREEN MICED GREY");
						 System.out.println(product16.getWashingMachineaircoolercolor());
						 
						 
						 product16.setAircoolerweight(12666356);
						 ...
						 product16.setAircoolermanufacturePlace("NAIDUPETA");
						 ...
						 product17.setWashingMachineaircoolercolor("WHITE-GREEN MICED GREY");
						 System.out.println(product16.getWashingMachineaircoolercolor());
						 ...
						 product17.setAircoolermanufacturePlace("NAIDUPETA");
						 ...
						 product17.setAircoolercouriercharge(17500);
	...
	*/
						 ...
						 product18.setColor("ORANGE");
						 System.out.println( product18.getColor());
						...
						product18.setBookcouriercharge(12345);
						System.out.println(product18.getBookcouriercharge(1234655));
						 ...
						 product19.setColor("ORANGE-blue");
						 System.out.println( product19.getColor());
						 
						 product19.setBookweight(19234);
						...
						product19.setAircoolermanufacturePlace("TIRUPATI");
						...
						product20.setAircoolermanufacturePlace("TIRUPATI");
						...
						product20.setBookcouriercharge(1234954);
						...
						ProductDTO product21=new ProductDTO();
						 ...
						 product21.setColor("RED");
						 System.out.println( product21.getColor());
						 
						 product21.setBookweight(4192434);
						...
						product21.setAircoolermanufacturePlace("kalahasti");
						...
						product21.setBookcouriercharge(12334954);
						...
						product22.setLaptop("HP");
						System.out.println(product22.getLaptop());
						
						product22.setLaptopprice(12345678);
						System.out.println(product22.getLaptopprice());
						 
						product22.setLaptopcolor("SILVER");
						System.out.println(product22.getLaptopcolor());
						
						product22.setLaptopweight(123);
						...
						product22.setLaptopmanufacturePlace("KADAPA");
						...
						product23.setLaptop("HP probook");
						System.out.println(product23.getLaptop());
						
						product23.setLaptopprice(12345678);
						System.out.println(product23.getLaptopprice());
						 
						product23.setLaptopcolor("SILVER_blue");
						System.out.println(product23.getLaptopcolor());
						...
						product23.setLaptopmanufacturePlace("KADAPA-KURNOOL");
                       ...
                       ProductDTO product24=new ProductDTO();
						...
						product24.setLaptop("LENOVA probook");
						System.out.println(product24.getLaptop());
						
						product24.setLaptopprice(1245678);
						System.out.println(product24.getLaptopprice());
						 
						product24.setLaptopcolor("BLACK");
						System.out.println(product24.getLaptopcolor());
						
						product24.setLaptopweight(1523);
						...
						product24.setLaptopmanufacturePlace("KADAPA-KURNOOL");
                       ...
                       product25.setLaptop("DELL probook");
						...
						product25.setLaptopcolor("GOLD");
						System.out.println(product25.getLaptopcolor());
						...
						product25.setLaptopmanufacturePlace("KADAPA-KURNOOL");
						...
						System.out.println(" 6 instance of product");
						 ...
						 product26.setGasStove("piegion");
						 System.out.println(product26.getGasStove());
						 
						 product26.setGasStoveprice(1234567890);
						 ...
						 product26.setGasStovecolor("blue");
						 System.out.println(product26.getGasStovecolor());
						 ...
						 product26.setGasStovemanufacturePlace("SRIHARIKOTA");
                        ...
                        ProductDTO product27=new ProductDTO();
						 ...
						 product27.setGasStovecolor("blue");
						 System.out.println(product27.getGasStovecolor());
						 
						 
						 product27.setGasStoveweight(7123);
						 ...
						 product27.setGasStovemanufacturePlace("SRIHARIKOTA");
                        ...
                        ProductDTO product28=new ProductDTO();
						 ...
						 product28.setGasStove("piegion SMART");
						 System.out.println(product28.getGasStove());
						 
						 product28.setGasStoveprice(1827890);
						 System.out.println(product28.getGasStoveprice());
						 
						 
						 product28.setGasStovesize(123);
						 System.out.println( product28.getGasStovesize());
						 
						 product28.setGasStovecolor("blue");
						 System.out.println(product28.getGasStovecolor());
						 
						 
						 product28.setGasStoveweight(1823);
						 ...
						 product28.setGasStovemanufacturePlace("SRIHARIKOTA");
						 System.out.println( product26.getGasStovemanufacturePlace());
						 ...
						 System.out.println( product28.getGasStovecharge());
						  ...
						  ProductDTO product29=new ProductDTO();
							 ...
							 product29.setGasStoveprice(1827890);
							 ...
							 product29.setGasStovecolor("PINK");
							 System.out.println(product29.getGasStovecolor());
							 
							 
							 product29.setGasStoveweight(17823);
							 ...
							 product29.setGasStovemanufacturePlace("SRIHARIKOTA");
			      ...
			      product30.setTshirtweight(123456);
			      System.out.println(product30.getTshirtweight());
			      
			      product30.setTshirtcolor("skyblue");
			      System.out.println( product30.getTshirtcolor());
			      ...
			      product30.setTshirtmanufacturePlace("RAJAMPET");
			      ...
			      product31.setTshirtweight(1323456);
			      System.out.println(product31.getTshirtweight());
			      
			      product31.setTshirtcolor("ORANGE");
			      System.out.println( product31.getTshirtcolor());
			      ...
			      product31.setTshirtmanufacturePlace("SRIKAKULAM");
			      ...
			      product32.setTshirtmanufacturePlace("SRIKAKULAM");
			      System.out.println(product31.getTshirtmanufacturePlace());
			      ...
			      product32.setTshirtcharge(1040);
			      ...
			      product33.setTshirt("POLO COAT WEAR");
			      ...
			      product33.setTshirtcolor("YELLOW");
			      System.out.println( product33.getTshirtcolor());
			      
			      product33.setTshirtweight(14300);
			      System.out.println(product33.getTshirtweight());
			      ...
			      product33.setTshirtmanufacturePlace("VIJAYNAGARAM");
