...
public class ProductDTO {
	...
	private String watchmanfacturePlace;
	...
	private int aircoolercouriercharge;
    	...
    	private String washingMachine="LG";
	    private int washingMachineprice;
		private int washingMachineaircoolersize;
		private String washingMachineaircoolercolor;
	...
	private String gasStove="BUTTERFLY";
	private int gasStoveprice;
	private int gasStovesize;
	private String gasStovecolor;
	...
	private String Tshirt="POLO FULL HAND";
	...
	public String getManfacturePlace() {
		return manfacturePlace;
	}
	
	public void setManfacturePlace(String manfacturePlace) {
		this.manfacturePlace = manfacturePlace;
	}
	...
	public String getAircoolercolor() {
		return aircoolercolor;
	}
	...
	public void setAircoolercolor(String aircoolercolor) {
		this.aircoolercolor = aircoolercolor;
	}
	...
	public String getWashingMachineaircoolercolor() {
		return washingMachineaircoolercolor;
	}
	
	public void setWashingMachineaircoolercolor(String washingMachineaircoolercolor) {
		this.washingMachineaircoolercolor = washingMachineaircoolercolor;
	}
	...
	public String getGasStovecolor() {
	return gasStovecolor;
   }
	
	public void setGasStovecolor(String gasStovecolor) {
		this.gasStovecolor = gasStovecolor;
	}
